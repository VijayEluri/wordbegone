...
<xsl:text>&#xA;</xsl:text>          
h1. Chapter <xsl:value-of select="@index"/>.<xsl:text>&nbsp;</xsl:text><xsl:value-of select="@title"/>
<xsl:text>&#xA;</xsl:text>  
...
<xsl:text>&#xA;</xsl:text>          
h1. Appendix <xsl:value-of select="@index"/>.<xsl:text>&nbsp;</xsl:text><xsl:value-of select="@title"/>
<xsl:text>&#xA;</xsl:text>  
        <xsl:apply-templates select="child::*"/>
    </xsl:template>
...
<xsl:text>&#xA;</xsl:text>        
h2. <xsl:value-of select="parent::chapter/@index"/>.<xsl:value-of select="@index"/><xsl:text>&nbsp;</xsl:text><xsl:value-of select="@title"/>
<xsl:text>&#xA;</xsl:text>
<xsl:text>&#xA;</xsl:text> 
        <xsl:apply-templates select="child::*"/>
    </xsl:template>
...
<xsl:text>&#xA;</xsl:text>        
h3. <xsl:value-of select="ancestor::chapter/@index"/>.<xsl:value-of select="parent::section/@index"/>.<xsl:value-of select="position()"/><xsl:text>&nbsp;</xsl:text><xsl:value-of select="@title"/>
<xsl:text>&#xA;</xsl:text> 
<xsl:text>&#xA;</xsl:text>            
        <xsl:apply-templates select="child::*"/>
    </xsl:template>
...
<xsl:text>&#xA;&#xA;</xsl:text>            
    ...
    <xsl:template match="underline">**<xsl:apply-templates/>**</xsl:template>    
    
    <xsl:template match="italic">_<xsl:apply-templates/>_</xsl:template>        
    
    <xsl:template match="essential">%{color:red}<xsl:apply-templates/>%</xsl:template>            
